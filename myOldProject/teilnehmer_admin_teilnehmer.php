...
debug_to_console("Hallo in teilnehmer_admin_teilnehmer.php");
...
//echo "<br>\$_SESSION['sess_login_rechte']: ".$_SESSION['sess_login_rechte'];
//echo "<br>\$_SESSION['sess_login_teilnehmer_id']: ".$_SESSION['sess_login_teilnehmer_id'];
//echo "<br>\$_GET['teilnehmer_id']: ".$_GET['teilnehmer_id'];


If (($_SESSION['sess_login_rechte'] !="administrator") and ($_SESSION['sess_login_teilnehmer_id']!=$_GET['teilnehmer_id']))
{	
	//echo "<br> keine Berechtigung!";
	//keine Berechtigung
	Header("location:http://".$_SERVER['SERVER_NAME']."/index.php");
}
//echo "<br>er ist über index hinweg!";
//Beim ersten Aufruf dieser Datei muss der Teilnehmer mit der übergebenen Id selektiert werden und seine Daten in die entsprechenden 
...
if (isset($_POST["speichern"])) {
  ...
  //echo "<br>\$gruppen_fid_h: ".$gruppen_fid_h;  
	...
	//echo "<br>speichern: ".$_POST['speichern'];
	formausgeben($nachname_h, $vorname_h, $strasse_h, $plz_h,$ort_h,$land_h,$geb_datum_h, $geb_ort_h, $staatsbuergerschaft_Nr_h,$passnr_h,$email_h,$mobil_nummer_zu_hause_h,$mobil_nummer_vor_ort_h,$club_h,$oesv_nr_h,$shirt_h,$sponsor_h,$bootstype_h,$bootsname_h,$gruppen_fid_h,$tiefgang_h,$anzahl_crew_h,$unterschrieben_h,$eigene_rg_adresse_h,$rg_zeile1_h,$rg_zeile2_h,$rg_zeile3_h,$rg_zeile4_h,$fehler);
}
...
function formausgeben($nachname_h= "", $vorname_h ="", $strasse_h = "", $plz_h="",$ort_h="",$land_h="",$geb_datum_h="", $geb_ort_h="", $staatsbuergerschaft_Nr_h=0,$passnr_h="",$email_h="",$mobil_nummer_zu_hause_h="",$mobil_nummer_vor_ort_h="",$club_h="",$oesv_nr_h="",$shirt_h="",$sponsor_h="",$bootstype_h="",$bootsname_h="",$gruppen_fid_h=0,$tiefgang_h="",$anzahl_crew_h="",$unterschrieben_h=0,$eigene_rg_adresse_h=0,$rg_zeile1_h="",$rg_zeile2_h="",$rg_zeile3_h="",$rg_zeile4_h="",$fehler="") {
...
?>
	...
	<table cellpadding="5" cellspacing="0">
    	<tr><td><input type="hidden" name="sprache" value="<?php echo $sprache; ?>"></td></tr>
		<tr>
	...
	?>   
		...
		<tr>
			<td align="left" bgcolor="#CCCCCC">Es ist nicht bekannt, ob beim Versenden der Erst-Email inklusive Anzahlungsrechnung und Zugangsdaten ein Fehler aufgetreten ist.
			</td>
		</tr>
    <?php
    }
	...
	?>
		<tr>
			<td align="left" bgcolor="#CCCCCC">Erst-Email-Versand OK. Zugangsdaten und Anzahlungsrechnung wurden erfolgreich zugestellt.
			</td>
		</tr>
	<?php
	} 
	...
	<div id="formular">	
		...
		<section class="navi-articles">
			...
			<article class="box navi">
				<table align="center">
				<tr>
					<form class="navi_hoehe" method="post" action="/teilnehmerliste_lesen.php?regatta_id=<?php echo $_SESSION['sess_regatta_id'];?>" name="teilnehmerliste">
					<td>
			...
			<article class="box navi">
				<table align="center">
				<tr>
					<form class="navi_hoehe" method="post" action="/zahlungsdetails_lesen.php?teilnehmer_id=<?php echo $_SESSION['sess_teilnehmer_id'];?>" name="zahlungsdetails_lesen">
			...
			<article class="box navi">
				<table align="center">
				<tr>
					<form class="navi_hoehe" method="post" action="/rechnungs_liste.php?teilnehmer_id=<?php echo $_SESSION['sess_teilnehmer_id'];?>" name="rechnungs_liste">
...
debug_to_console("Ende teilnehmer_admin_teilnehmer.php");
?>
</body>
</html>