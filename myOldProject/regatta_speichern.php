...
if ($_POST['speichern']=="Speichern") {
		//echo "Restzahlung f�llig bis: ".$_POST['restzahlung_faellig_bis'];
        //es wurde auf SPEICHERN gedr�ckt
        //�berpr�fung der Daten erfolgte bereits auf der vorigen Seite
		...
		$regatta_id=$mydb->lastInsertId();	//gibt den letzten vergebenen Autoincrement-Wert zur�ck
